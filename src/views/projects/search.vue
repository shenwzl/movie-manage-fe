      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="项目执行状态" label-width="120px">
            <el-select v-model="searchInfo.states" @change="onStateChange" style="width: 216px;" multiple>
        ...
        <el-col :span="8">
          <el-form-item label="拍摄开始日期" label-width="120px">
            <el-date-picker style="width: 100px" v-model="searchInfo.shootingStartAtStart" autocomplete="off" />
            ~
            <el-date-picker style="width: 100px;" v-model="searchInfo.shootingStartAtEnd" autocomplete="off" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
    ...
    getSpanArr() {
      ...
      this.searchList.forEach((item, i) => {
        if (i === 0) {
          ...
          if (item.name === this.searchList[i - 1].name && item.categoryId && item.categoryId === this.searchList[i - 1].categoryId) {
